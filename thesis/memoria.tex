...
\caption{A sample of some frames after processing the entirety of the videos. Notice the changes on the gymball camera angle on images b (bottom left) and c (right).}
\end{figure}

...
Explicar características, fuentes de obtención, limitaciones y más.
...
\begin{itemize}
	\item Obtenemos muy buenas precisiones: YOLOv8s + YOLOv8l + YOLOv11s + YOLOv11l (mejor precisión con YOLOv11, pero resultados muy aceptables con YOLOv8).

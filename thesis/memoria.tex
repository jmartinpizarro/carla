...
The AI Act also mentions that the systems must be explainable (explainable AI - XAI). The goal of XAI is quite ambitious: surpassing the black box issue and integrating algorithms with human values, empowering and enhancing the individual in the decision-making process \cite{ALI2023101805}. 
...
However, in the region of South America (were this work aims to be relevant) different specific laws have been approved in order to regulate these topics, specially about \textbf{data protection and privacy and about the usage of drones}.

Regulations about UAVs are highly strict. Civil unmanned aircrafts (such as those used for monitoring or research) cannot surpass an altitude limit of 122 meters and a maximum velocity of 161 km/h \cite{Sanchez23}. Although these laws are not really well defined in the continent, Brazil and Argentina are the exceptions; with more than seventy articles and laws defining limits and certifications depending on the capabilities and weights of the drones.

On the other hand, the law in Uruguay is more salmon: for sports or recreation flights it is not required to ask for a flight permit from the goverment.

Image and video capture and usage is highly regulated due to the data and privacy policies of each country, specially when it involves images of people.
...
\textbf{Se debería de probar con más tipos de imágenes de muestreo. No tengo tokens suficientes.}

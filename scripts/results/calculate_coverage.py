...
def main():
    ...
    for model in models:
        ...
        for image in os.listdir(f'{data}/test/images'):
            ...
            models_coverage[model]["gt"].append(gt_coverage_percent(image_route, label_route))
            models_coverage[model]["pred"].append(pred_coverage_percent(image_route, yolo_model))
